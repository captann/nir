...
// Дополнительные регистры SYSCTL
...
#define INT_WATCHDOG         18  // Вектор прерывания Watchdog Timer

// Максимальное количество записей в логе
#define DIAG_MAX_LOG_ENTRIES 100

// ADC and GPIO bit definitions
...
#define WATCHDOG0_CTL_R      (*((volatile uint32_t *)0x40000000))  // Регистр управления WDT
#define WATCHDOG0_LOAD_R     (*((volatile uint32_t *)0x40000004))  // Регистр загрузки WDT
...
#define WATCHDOGO_RIS_R      (*((volatile uint32_t *)0x40001000))
